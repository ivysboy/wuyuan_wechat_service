package com.wuyuan.wechat.handler.wangshenghuo;

import com.wuyuan.wechat.config.ApolloWeChatConfig;
import com.wuyuan.wechat.handler.UnsubscribeHandler;
 ...
 */
@Component
public class WshUnSubscribeHandler extends UnsubscribeHandler {
